...
<div class="table-responsive col-lg-6">
    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        {{-- loop->iteration -> bilangin dimuali dari 1, sedangkan index 0 --}}
        <tr>
            ...
            <td>
                ...
                <form action="/dashboard/categories/{{ $category->id }}" method="post" class="d-inline">
                  @method('delete')
                  @csrf
                  <button class="badge bg-danger border-0" onclick="return confirm('Are you sure delete data?')"><span data-feather='x-circle'></span></button>
                </form>
