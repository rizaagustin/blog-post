...
@section('container')
    ...
    @if($posts->count())
        <div class="card mb-3 text-center">
            @if($posts[0]->image)
                <img style="max-height:350px; overflow:hidden;" src="{{ asset('storage/' . $posts[0]->image)}}" alt="{{$posts[0]->category->name }}" class="img-fluid mt-3">                
                <img style="max-height:350px; overflow:hidden;" src="{{ url(Storage::url($posts[0]->image)) }}" alt="{{$posts[0]->category->name }}" class="img-fluid mt-3">                
            @else
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    ...
                    @if($post->image)
                        <img src="{{ $post->image }}" class="card-img-top" alt="{{ $post->category->name }}">                                                
                    @else
